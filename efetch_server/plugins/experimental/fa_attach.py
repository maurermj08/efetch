...
class FaAttach(IPlugin):
    ...
    # This list should be limited to files that have generic mimetypes but very common extensions
    ...
    def base64_evidence(evidence, helper):
        ...
        if evidence['mimetype'] in FaAttach.tika_supported or \
                (hasattr(evidence, 'extension') and evidence['extension'] in FaAttach.supported_extensions):
            return {
                '_indexed_chars': -1,
